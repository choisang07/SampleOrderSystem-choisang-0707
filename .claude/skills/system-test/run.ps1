...
$cases = @(
    ...
    @{
        ...
        Expect     = "==============================`n 반도체 시료 생산주문관리 시스템`n==============================`n[1] 시료 관리       [2] 시료 주문`n[3] 주문 승인/거절  [4] 모니터링`n[5] 생산라인 조회   [6] 출고 처리`n[0] 종료`n선택 > __________________________________________________`n[1] 시료 관리`n__________________________________________________`n[1] 시료 등록    [2] 시료 목록    [3] 시료 검색    [0] 뒤로`n선택 > 이름 > 평균 생산시간 > 수율 > 등록이 완료되었습니다. (ID: S-001)`n__________________________________________________`n[1] 시료 관리`n__________________________________________________`n[1] 시료 등록    [2] 시료 목록    [3] 시료 검색    [0] 뒤로`n선택 > ==============================`n 반도체 시료 생산주문관리 시스템`n==============================`n[1] 시료 관리       [2] 시료 주문`n[3] 주문 승인/거절  [4] 모니터링`n[5] 생산라인 조회   [6] 출고 처리`n[0] 종료`n선택 > "
    }
    ...
    @{
        ...
        InputLines = @('1', '2', '0', '0')
        Expect     = "==============================`n 반도체 시료 생산주문관리 시스템`n==============================`n[1] 시료 관리       [2] 시료 주문`n[3] 주문 승인/거절  [4] 모니터링`n[5] 생산라인 조회   [6] 출고 처리`n[0] 종료`n선택 > __________________________________________________`n[1] 시료 관리`n__________________________________________________`n[1] 시료 등록    [2] 시료 목록    [3] 시료 검색    [0] 뒤로`n선택 > 등록된 시료가 없습니다.`n__________________________________________________`n[1] 시료 관리`n__________________________________________________`n[1] 시료 등록    [2] 시료 목록    [3] 시료 검색    [0] 뒤로`n선택 > ==============================`n 반도체 시료 생산주문관리 시스템`n==============================`n[1] 시료 관리       [2] 시료 주문`n[3] 주문 승인/거절  [4] 모니터링`n[5] 생산라인 조회   [6] 출고 처리`n[0] 종료`n선택 > "
    }
    ...
    @{
        ...
        Expect     = "==============================`n 반도체 시료 생산주문관리 시스템`n==============================`n[1] 시료 관리       [2] 시료 주문`n[3] 주문 승인/거절  [4] 모니터링`n[5] 생산라인 조회   [6] 출고 처리`n[0] 종료`n선택 > __________________________________________________`n[1] 시료 관리`n__________________________________________________`n[1] 시료 등록    [2] 시료 목록    [3] 시료 검색    [0] 뒤로`n선택 > 이름 > 평균 생산시간 > 수율 > 등록이 완료되었습니다. (ID: S-001)`n__________________________________________________`n[1] 시료 관리`n__________________________________________________`n[1] 시료 등록    [2] 시료 목록    [3] 시료 검색    [0] 뒤로`n선택 > 검색어 > 등록 시료 목록 (총 1 종)`nID`t시료명`t평균 생산시간`t수율`t현재 재고`nS-001`tWaferA`t2`t0.9`t0`n__________________________________________________`n[1] 시료 관리`n__________________________________________________`n[1] 시료 등록    [2] 시료 목록    [3] 시료 검색    [0] 뒤로`n선택 > ==============================`n 반도체 시료 생산주문관리 시스템`n==============================`n[1] 시료 관리       [2] 시료 주문`n[3] 주문 승인/거절  [4] 모니터링`n[5] 생산라인 조회   [6] 출고 처리`n[0] 종료`n선택 > "
    }
    ...
    @{
        ...
        Expect     = "==============================`n 반도체 시료 생산주문관리 시스템`n==============================`n[1] 시료 관리       [2] 시료 주문`n[3] 주문 승인/거절  [4] 모니터링`n[5] 생산라인 조회   [6] 출고 처리`n[0] 종료`n선택 > __________________________________________________`n[1] 시료 관리`n__________________________________________________`n[1] 시료 등록    [2] 시료 목록    [3] 시료 검색    [0] 뒤로`n선택 > 이름 > 평균 생산시간 > 수율 > 등록이 완료되었습니다. (ID: S-001)`n__________________________________________________`n[1] 시료 관리`n__________________________________________________`n[1] 시료 등록    [2] 시료 목록    [3] 시료 검색    [0] 뒤로`n선택 > 등록 시료 목록 (총 1 종)`nID`t시료명`t평균 생산시간`t수율`t현재 재고`nS-001`tWaferA`t2`t0.9`t0`n__________________________________________________`n[1] 시료 관리`n__________________________________________________`n[1] 시료 등록    [2] 시료 목록    [3] 시료 검색    [0] 뒤로`n선택 > 검색어 > 등록 시료 목록 (총 1 종)`nID`t시료명`t평균 생산시간`t수율`t현재 재고`nS-001`tWaferA`t2`t0.9`t0`n__________________________________________________`n[1] 시료 관리`n__________________________________________________`n[1] 시료 등록    [2] 시료 목록    [3] 시료 검색    [0] 뒤로`n선택 > ==============================`n 반도체 시료 생산주문관리 시스템`n==============================`n[1] 시료 관리       [2] 시료 주문`n[3] 주문 승인/거절  [4] 모니터링`n[5] 생산라인 조회   [6] 출고 처리`n[0] 종료`n선택 > "
    }
)
