...
- Phase 구성은 [PLAN.md](PLAN.md)의 Phase 0~5 표를 따른다 (시료 관리 → 주문 접수 → 승인/거절+생산라인 → 출고 → 모니터링 순).
...
### 4. 문서 최신화
- 요구사항/아키텍처/계획에 변경이 생기면 requirement.md, PRD.md, PLAN.md 중 해당 문서를 함께 갱신한다.
...
| `[docs]` | CLAUDE.md/PRD.md/PLAN.md/design.md 등 문서 변경 |
